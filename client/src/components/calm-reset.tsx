                      ...
                      <Card className="p-4 sm:p-6 md:p-8 border border-sky-200 bg-gradient-to-br from-sky-50 to-blue-50 shadow-lg animate-gentle-fade">
                        <div className="text-center space-y-6">
                          ...
                          <div className="flex flex-col items-center space-y-4 sm:space-y-6">
                            {/* Main breathing circle with animated border */}
                            <div className="relative">
                              {/* Main breathing circle - outer container with animated border */}
                              <div className={`
                                relative w-40 h-40 sm:w-48 sm:h-48 rounded-full bg-gradient-to-br from-blue-50 via-sky-25 to-blue-50 flex items-center justify-center shadow-2xl overflow-hidden mx-auto
                                transition-all duration-300 ease-linear
                              `}
                                   style={{
                                     border: `4px solid rgb(59 130 246)`,
                                     boxShadow: `0 0 30px rgba(59, 130, 246, 0.4), inset 0 0 20px rgba(59, 130, 246, 0.1), 0 0 0 ${Math.floor((progress / 100) * 20)}px rgba(59, 130, 246, ${0.3 - (progress / 100) * 0.2})`
                                   }}>
